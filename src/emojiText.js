    ...
    function draw(nodes, links) {
        ...
        node.append("image")
            ...
            .attr("xlink:href", function (d) {
                return (document.location.origin.toString() + "/emojitext/media/images/" + emotionPolarity[d.emotion] + ".svg");
            })
            .attr("emotion", function (d) {
                return (document.location.origin.toString() + "/emojitext/media/images/" + emotionPolarity[d.emotion] + ".svg");
            })
            .attr("polarity", function (d) {
                return (document.location.origin.toString() + "/emojitext/media/images/" + emotionPolarity[d.polarity] + ".svg");
            })
